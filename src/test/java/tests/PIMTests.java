...
public class PIMTests {
    ...
    public void verifyAdminCanCreateEmployee(){
        ...
        // Option 2 to verify
//        Assertions.assertEquals(empIdInTable.getText(), pimPage.empID);
//        Assertions.assertEquals(firstNameInTable.getText(), pimPage.fName);
//        Assertions.assertEquals(lastNameInTable.getText(), pimPage.lName);
